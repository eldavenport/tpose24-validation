...
model_prof_data = '/data/SO3/edavenport/tpose24/oct2012_3month_transp_cons/PROF/'; % where the model equivalent profiles are
output_netcdf_data = '/data/SO3/edavenport/tpose24/oct2012_3month_transp_cons/PROF_eq/'; % where to put the converted profiles
